    ...
    <div>
        ...
        <div id="div_1" >
            <asp:Label CssClass="cssLabels" ID="lbl_doc" runat="server" Text="Documento">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="drp_Pais" CssClass="validators" Display="Dynamic" InitialValue="Seleccionar" ValidationGroup="AllValidators">*</asp:RequiredFieldValidator><br />
        </div>
        <br />
        <div id="div_2">            
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_documento" Display="Dynamic" SetFocusOnError="True" ValidateRequestMode="Enabled" ValidationGroup="AllValidators" ViewStateMode="Enabled" CssClass="validators">*</asp:RequiredFieldValidator>
        </div>
        <br />
